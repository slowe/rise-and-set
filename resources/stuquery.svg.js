...
function SVG(id,w,h,opts){
	...
	this.id = id;
	this.canvas.html('<svg height="'+this.h+'" version="1.1" width="'+this.w+'" viewBox="'+(opts.viewBox||'0 0 '+this.w+' '+this.h)+'" xmlns="http://www.w3.org/2000/svg"><desc>Created by stuQuery SVG</desc></svg>');
